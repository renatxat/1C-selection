...
class Window(tk.Tk):
    ...
    def __tune_window(self):
        ...
        self.tk.call("wm", "iconphoto", self._w, tk.PhotoImage(file=resource_path("resource/main_icon.png")))
        img = ImageTk.PhotoImage(file=resource_path("resource/main_icon.png"))
